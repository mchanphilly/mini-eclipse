...
MyTime::MyTime(int year, int month, int day, int hour, int minute, int utcOffset) {
...
MyTime::MyTime(String timeString) {
    ...
    unixTime = listToUnix(fields[0], fields[1], fields[2], fields[3], fields[4], fields[5]);
}
...
time_t MyTime::listToUnix(int year, int month, int day, int hour, int minute, int utcOffset) {
